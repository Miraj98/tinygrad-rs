...
pub struct TensorOuter<A, D, D1> where A: Clone, D: Dimension, D1: Dimension {
    inner: Rc<TensorInner<A, D>>,
    saved_tensors: Vec<Rc<TensorInner<A, D1>>>
}
